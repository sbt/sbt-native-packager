...
trait DebianKeys {
  ...
  val debianPackageConflicts = SettingKey[Seq[String]](
    ...
    "Packages that conflict with the currently packaged one.")
  ...
  val debianPackageProvides = SettingKey[Seq[String]](
    "debian-package-provides",
    "Packages that are provided by the currently packaged one.")
  ...
  val debianUpstartFile = TaskKey[File](
    "debian-upstart-file",
    "Makes the upstart file for this debian package.")
  val debianLinksfile =
  ...
  val debianZippedMappings = TaskKey[Seq[LinuxPackageMapping]](
    "debian-zipped-mappings",
    "Files that need to be gzipped when they hit debian.")
  val debianCombinedMappings = TaskKey[Seq[LinuxPackageMapping]](
    "debian-combined-mappings",
    "All the mappings of files for the final package.")
  val debianExplodedPackage = TaskKey[File]("debian-exploded-package",
                                            "makes an exploded debian package")
  val lintian = TaskKey[Unit](
    "lintian",
    "runs the debian lintian tool on the current package.")
  val debianSign = TaskKey[File](
    "debian-sign",
  ...
  val debianNativeBuildOptions = SettingKey[Seq[String]](
    "debian-native-build-options",
    "Options passed to dpkg-deb, e.g. compression level")
}
