...
import sbt.{File, TaskKey, SettingKey}
...
trait AshStartScriptKeys {
  ...
  val ashScriptReplacements = TaskKey[Seq[(String, String)]]("ashScriptReplacements", "Replacements of template parameters used in the bash script.")
