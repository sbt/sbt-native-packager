...
trait RpmKeys {
  ...
  val rpmChangelogFile = SettingKey[Option[String]](
    "rpm-changelog-file",
    "RPM changelog file to be imported")
  ...
  val rpmAutoprov = SettingKey[String](
    "rpm-autoprov",
    "enable/disable automatic processing of 'provides' (\"yes\"/\"no\").")
  val rpmAutoreq = SettingKey[String](
    "rpm-autoreq",
    "enable/disable automatic processing of requirements (\"yes\"/\"no\").")
  val rpmProvides =
  ...
  val rpmSetarch = SettingKey[Option[String]](
    "rpm-setarch",
    "run rpmbuild in the context of an architecture.")

  // MAINTAINER SCRIPTS
  @deprecated(
    "Use maintainerScripts in RPM and RpmConstants.Pretrans instead.",
    "1.1.x")
  val rpmPretrans =
    SettingKey[Option[String]]("rpm-pretrans", "%pretrans scriptlet")
  @deprecated("Use maintainerScripts in RPM and RpmConstants.Pre instead.",
              "1.1.x")
  val rpmPre = SettingKey[Option[String]]("rpm-pre", "%pre scriptlet")
  @deprecated(
    "Use maintainerScripts in RPM and RpmConstants.Verifyscript instead.",
    "1.1.x")
  val rpmVerifyscript =
    SettingKey[Option[String]]("rpm-verifyscript", "%verifyscript scriptlet")
  @deprecated("Use maintainerScripts in RPM and RpmConstants.Post instead.",
              "1.1.x")
  val rpmPost = SettingKey[Option[String]]("rpm-post", "%post scriptlet")
  @deprecated(
    "Use maintainerScripts in RPM and RpmConstants.Posttrans instead.",
    "1.1.x")
  val rpmPosttrans =
    SettingKey[Option[String]]("rpm-posttrans", "%posttrans scriptlet")
  @deprecated("Use maintainerScripts in RPM and RpmConstants.Preun instead.",
              "1.1.x")
  val rpmPreun = SettingKey[Option[String]]("rpm-preun", "%preun scriptlet")
  @deprecated("Use maintainerScripts in RPM and RpmConstants.Postun instead.",
              "1.1.x")
  ...
  val rpmDaemonLogFile = SettingKey[String](
    "rpm-daemon-log-file",
    "Name of the log file generated by application daemon")
